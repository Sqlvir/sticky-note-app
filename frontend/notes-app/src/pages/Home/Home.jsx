...
import AddNotesImg from "../../assets/images/no-data.svg";
import NoSearchImg from "../../assets/images/no-search-data.jpg";
...
const Home = () => {
  ...
  const getAllNotes = async () => {
     try {
        ...
        console.log("An unexpected error occurred. Please wait!");
     }
  };
  ...
  return (
    <>
      ...
      <div className="container mx-auto card-section">
        {allNotes.length > 0 ? (
         ...
         {allNotes.map((item, index) => (
           ...
           <EmptyCard 
           imgSrc={
            isSearch ? NoSearchImg : AddNotesImg
            } 
            message={
      ...
      <button className="w-12 h-12 flex items-center justify-center rounded-2xl hover:shadow-md transition-all ease-in-out absolute right-10 bottom-10 addNotes" 
         onClick={() => {
            setOpenAddEditModal({isShown: true, type:"add", data: null});
         }}>
            <MdAdd className="text-[25px] text-black addnotesButton" />
      </button>
