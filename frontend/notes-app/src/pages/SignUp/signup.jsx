  ...
  return (
    <>
      ...
      <div className='flex item-center justify-center mt-48'>
        <div className='w-96 border rounded bg-white px-7 py-10 signup-box'>
          ...
          <h2 className='text-xl font-medium text-black item-center justify-center py-2'><span>Sticky</span> <img src={Logo} /></h2>
            ...
            <button type='submit' className='btn-primary register-button'>Register Now</button>
              
            <p className='text-sm text-center mt-4'>
              Already have an account?{" "}
              <Link to="/login" className='font-medium text-primary hover:underline signin-text'>LogIn</Link>
            </p>
